...
* **Let the `kotlin-dsl` plugin configure precompiled script plugins support** ([#1135](https://github.com/gradle/kotlin-dsl/issues/1135))
    ...
    Applying the `kotlin-dsl` plugin now also applies the `kotlin-dsl-precompiled-script-plugins` plugin.
    See the [Gradle Kotlin DSL Primer](https://docs.gradle.org/5.0-milestone-1/userguide/kotlin_dsl.html) chapter of the Gradle User Manual for more information. 
